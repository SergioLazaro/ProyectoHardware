...
sudoku_candidatos_modificar:
		...
		#Valor insertado correcto o incorrecto
		MOV		r6, #1
		ADD		r3, r3, #3
		ADD		r6, r6, LSL r3
		AND		r6, r5, r6		//Obtenemos bit del valor

		CMP		r6, #0
		BGT		propagar_correcto	//Caso correcto

		#Modificar bit 14 para indicar error
		MOV		r6, #1
		ADD		r6, r6, LSL #13
		ORR		r5, r5, r6		//Establecemos bit error = 1
		ORR		r5, r5, r3		//Establecemos valor erroneo en los 4 primeros bits
		STRH	r5, [r4]		//Actualizamos valor de celda con bit error
		MOV		r0, #-1
		B		fin_comprobar
...
borrar_valor_celda:
		AND		r5, r5, #0		//Metemos 0 en bits de valor
		STRH	r5, [r4]
		BL		sudoku_candidatos_init_arm
		MOV		r0, #3
		B 		fin_comprobar
