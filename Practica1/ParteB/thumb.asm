...
# function __c_copy is in copy.c
		...
		MOV		r1, #4
		MOV		r2, #6
		LDR		r3, =sudoku_candidatos_propagar_thumb
		BX		r3
.extern     sudoku9x9
        ldr         r5, =sudoku9x9
        mov         lr, pc
...
sudoku_candidatos_propagar_thumb:
		...
		MOV		r4, r0			//r4 -> posicion elemento
		LSL		r5, r1, #5
		ADD		r4, r4, r5
		...
		//Comprobar si es necesario en 2. Creo que no.
		LSR		r6, r5, #15		//r6 -> 1 (pista) o 0 (vacio)
